...
class AccessToken extends AbstractAPI
{
    ...
    protected $container;
    protected $accessTokenCacheKey = 'sinre.LWechat.oauth_access_token.';
    protected $refreshTokenCacheKey = 'sinre.LWechat.oauth_refresh_token.';
     ...
     * @param array|\LWechat\Core\Collection $data access token 信息
     */
